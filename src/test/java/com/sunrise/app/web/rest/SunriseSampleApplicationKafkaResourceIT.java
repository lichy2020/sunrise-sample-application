...
import com.sunrise.app.config.KafkaProperties;
...
class SunriseSampleApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        SunriseSampleApplicationKafkaResource kafkaResource = new SunriseSampleApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/sunrise-sample-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/sunrise-sample-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
