...
@RestController
@RequestMapping("/api/sunrise-sample-application-kafka")
public class SunriseSampleApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SunriseSampleApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SunriseSampleApplicationKafkaResource(KafkaProperties kafkaProperties) {
